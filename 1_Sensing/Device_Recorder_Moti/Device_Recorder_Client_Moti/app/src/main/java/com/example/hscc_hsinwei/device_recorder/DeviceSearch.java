...
import static com.example.hscc_hsinwei.device_recorder.BluetoothLeService.CHARAC_WRITE;
import static com.example.hscc_hsinwei.device_recorder.BluetoothLeService.CUSTOM_SERVICE;
...
public class DeviceSearch extends AppCompatActivity {
    ...
    public void sendDataViaSocket(byte[] byteArrayExtra, String name){
        ...
        double xGyro =  ByteBuffer.wrap(byteArrayExtra, 12, 2).getShort()*Math.PI/180/65.5;
        double yGyro =  ByteBuffer.wrap(byteArrayExtra, 14, 2).getShort()*Math.PI/180/65.5;
        double zGyro =  ByteBuffer.wrap(byteArrayExtra, 16, 2).getShort()*Math.PI/180/65.5;
